        ...
        private void LoadTreatment()
        {
            ...
            if (tab.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < tab.Rows.Count; i++)
                {
                    ...
                    cellDisease.Text = DropDownListDiseases.SelectedItem.Text;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            BLL obj = new BLL();
                ...
                if (btnSubmit.Text.Equals("Submit"))
                {
                    try
                    {
                        obj.InsertTreatment(txtTreatment.Text, DateTime.Now);
                ...
                {
                    obj.UpdateTreatment(txtTreatment.Text, DateTime.Now, int.Parse(Session["treatmentId"].ToString()));
